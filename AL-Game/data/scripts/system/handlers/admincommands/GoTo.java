...
public class GoTo extends AdminCommand{
	...
	public void execute(Player player, String... params) {
		 ...
		 * 3.5
		 */
		else if(destination.equalsIgnoreCase("Dragon") || destination.equalsIgnoreCase("Dragon Lords Refuge")){
			goTo(player, 300520000, 506, 516, 242);
		}
		else if(destination.equalsIgnoreCase("Throne") || destination.equalsIgnoreCase("Throne of Blood")){
			goTo(player, 300520000, 495, 528, 417);
		}
        else if (destination.equalsIgnoreCase("Tiamat") || destination.equalsIgnoreCase("Tiamat Stronghold")) {
